...
a.bb.list = [
	...
	new a.bb.create("Produce God I<br><br>",			"Own 300 Produce Stands",	"Produce Stand speed x2", 'owned[0]', 300,		'timeMultiplier[0]', '/2'),
	...
	new a.bb.create("Delivery God I<br><br>",		"Own 300 Package Delivery Companies",	"Package Delivery speed x2",			'owned[1]',	300,	'timeMultiplier[1]', '/2'),
	...
	new a.bb.create("Coolest Toys VI<br><br>",		"Own 300 Daycare",		"Daycare speed x2",				'owned[2]',	300,	'timeMultiplier[2]', '/2'),
	...
	new a.bb.create("Fast Cars VI<br><br>",	"Own 300 Car Dealership",	"Car Dealership speed x2",	'owned[3]',	300,	'timeMultiplier[3]', '/2'),
];
